            ...
            {cart.map((item) => (
              <div className={body}>
                ...
                <div className={buttons}>
                  <button onClick={() => dispatch(incrementQuantity(item?.uid))}>+</button>
                  <button onClick={() => dispatch(decrementQuantity(item?.uid))}>-</button>
                  <button onClick={() => dispatch(removeFromCart(item?.uid))}>x</button>
                </div>
