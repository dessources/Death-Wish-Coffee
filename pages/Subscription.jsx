        ...
        <>
            ...
            <Container className='benefits'>
                ...
                >
                    ...
                    <Card sx={{ maxWidth: '50%' }} style={{ backgroundColor: 'black',marginTop: 15 }} className="truckResp">
                        <CardMedia
                    ...
                    <Card sx={{ maxWidth: '50%' }} style={{ backgroundColor: 'black',marginTop: 15 }} className="savingsResp">
                        <CardMedia
                            sx={{height: 48, width: 76, margin: 'auto'}}
                            component="img"
                            alt="savings"
            ...
            >
                ...
                <Typography
                    variant="h1"
                    align='center'
                    className='needHelpTitle'
                >
                    NEED HELP CHOOSING ?
                </Typography>
                <Typography
                    variant="body1"
                    className='needHelpText'
                >
